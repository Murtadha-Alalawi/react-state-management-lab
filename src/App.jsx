...
const App = () => {
  ...
  function handleAddFighter(fighter){
    ...
    const updatedFighters = zombieFighters.filter(zf => zf.id !== fighter.id)
  ...
  const totalStrength = team.reduce((total, friend)=> total + friend.strength, 0)
  const totalAgility = team.reduce((total, friend)=> total + friend.agility, 0)
  return (
    <div>
      ...
      <ul>
        {zombieFighters.map((fighter)=>(
          <li key={fighter.id}>
            ...
            <img src={fighter.img} alt={fighter.name} width="150"></img>
      ...
      <ul>{team.map((member)=>(
        <li key={member.id}>
          ...
          <img src={member.img} alt={member.name} width="150"></img>
